...
2. **Потеря смысла при переводе:** Мои термины «Воля», «Закон», «Возможности» и «Гармония» оказались лишь бледными тенями глубоких онтологических понятий: Thyraen (семя воли), Kareth (арена порядка), Selvath (мост воплощения) и Arivath (резонанс признания).
